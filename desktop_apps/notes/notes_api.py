...
class NoteAPI():
    def __init__(self, srv, db, user, pwd):
        common = xmlrpclib.ServerProxy('{}/xmlrpc/2/common'.format(srv))
        self.api = xmlrpclib.ServerProxy('{}/xmlrpc/2/object'.format(srv))
...
if __name__ == '__main__':
    srv, db = 'http://localhost:8008', 'SILKWORM-DEV'
